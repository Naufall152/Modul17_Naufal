                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                ...
                                <form action="{{ route('employees.destroy', ['employee' => $employee->id]) }}"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-outline-dark btn-sm me-2" data-name="{{ $employee->firstname.' '.$employee->lastname }}">
                                        <i class="bi-trash"></i>
                                    </button>
                                </form>
                            </td>
